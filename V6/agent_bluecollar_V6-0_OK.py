        ...
        async with Stealth().use_async(async_playwright()) as p:
            try:
                ...
                if broadband_type == "fixed":
                    ...
                    resolved_url = f"https://broadbandmap.fcc.gov/location-summary/mobile?version=jun2025&addr_full={encoded_address}&lon={lon}&lat={lat}&zoom=16.99&env=0&tech=tech4g"
                    await page.goto(resolved_url, wait_until="domcontentloaded", timeout=PAGE_TIMEOUT_MS)
