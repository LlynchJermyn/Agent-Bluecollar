...
# Basis: V4.5 Native Linux (Source 7) mit resolved_url Fix
# ----------------------------------------
    ...
    async with agent_lock:
        ...
        async with Stealth().use_async(async_playwright()) as p:
            try:
                ...
                # Polling mit Fast-Fail und deinem 15s Timeout
                ...
                final_payload = {"store_id": store_id, "broadband_type": broadband_type, "resolved_url": resolved_url, "status": "error", "message": str(e)}
