# ----------------------------------------
# AGENT BLUECOLLAR V4.1: THE PERFECT EXTRACTOR
...
# FIX: Lock nur deklarieren, noch nicht instanziieren!
agent_lock = None

@app.on_event("startup")
async def startup_event():
    global agent_lock
    # FIX: Lock wird erst erstellt, wenn die Uvicorn Event-Loop läuft.
...
if __name__ == "__main__":
    ...
    print(f"🚀 Starte API Server auf {api_host}:{api_port} (V4.1 - The Perfect Extractor)")
